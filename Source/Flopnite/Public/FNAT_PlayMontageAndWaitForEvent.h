...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FFNPlayMontageAndWaitForEventDelegate, FGameplayTag, EventTag, FGameplayEventData, EventData);
...
public:
	...
	UFNAT_PlayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	UPROPERTY()
	FFNPlayMontageAndWaitForEventDelegate OnCompleted;

	/** The montage started blending out */
	UPROPERTY()
	FFNPlayMontageAndWaitForEventDelegate OnBlendOut;

	/** The montage was interrupted */
	UPROPERTY()
	FFNPlayMontageAndWaitForEventDelegate OnInterrupted;

	/** The ability task was explicitly cancelled by another ability */
	UPROPERTY()
	FFNPlayMontageAndWaitForEventDelegate OnCancelled;

	/** One of the triggering gameplay events happened */
	UPROPERTY()
	FFNPlayMontageAndWaitForEventDelegate EventReceived;
	 ...
	 */
	UFUNCTION()
	static UFNAT_PlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
...
private:
	...
	UFNAbilitySystemComponent* GetTargetASC();
